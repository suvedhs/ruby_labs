...
def englishNumber number
  ...
  left -= write*1000000
  if write > 0
    mil = englishNumber write
    numString = numString + mil + ' million'
    if left > 0
      numString += ' '
    end
  end
...
puts
while bottles != 0
  english_bottles = englishNumber bottles
  puts english_bottles + ' bottles of beer on the wall, ' + english_bottles + ' bottles of beer!'
  bottles -= 1
  puts 'take one down, pass it around, ' + english_bottles + ' bottles of beer on the wall!'
end
